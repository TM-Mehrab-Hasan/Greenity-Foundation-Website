      ...
      <main className="flex flex-col gap-16 py-20 px-8 sm:px-20 max-w-6xl w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col gap-8">
            <div className="p-10 bg-surface rounded-[2.5rem] border border-border flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-6">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="opacity-70">{dictionary.common.location}</p>
                  </div>
                </div>
            ...
            <div className="p-10 bg-background rounded-[2.5rem] border border-border flex flex-col gap-6 shadow-xl shadow-foreground/5 overflow-hidden relative">
              ...
              <a 
                href="mailto:volunteer@greenityfoundation.org" 
          ...
          <div className="relative h-full min-h-[400px] w-full rounded-[3rem] overflow-hidden border border-border group">
            <Image 
            ...
            <div className="absolute bottom-10 left-10 right-10">
              ...
              <p className="text-foreground text-2xl font-black tracking-tight leading-tight">
