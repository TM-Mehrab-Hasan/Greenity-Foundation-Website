    ...
    <div className="flex flex-col items-center min-h-screen bg-background text-foreground eco-texture">
      <main className="flex flex-col gap-24 py-20 px-8 sm:px-20 max-w-6xl w-full">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="p-10 bg-surface rounded-[2.5rem] border border-border flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-8 duration-700">
            <h2 className="text-3xl font-black tracking-tight flex items-center gap-3">
              <span className="w-8 h-8 rounded-full bg-foreground text-background flex items-center justify-center text-sm shadow-sm">1</span>
          ...
          <div className="p-10 bg-background rounded-[2.5rem] border border-border flex flex-col gap-6 shadow-xl shadow-foreground/5 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
            <h2 className="text-3xl font-black tracking-tight flex items-center gap-3">
              <span className="w-8 h-8 rounded-full bg-primary-green text-background flex items-center justify-center text-sm shadow-sm">2</span>
        ...
        {/* Core Values */}
        <section className="flex flex-col gap-12 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-300">
